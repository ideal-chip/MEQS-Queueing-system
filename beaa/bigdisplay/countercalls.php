...
$counterNumber = getValue("SELECT counter_no FROM counters WHERE counter_id =(SELECT counter_id FROM bigdisplayforcounter WHERE bd_id = $displayID);");
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body style="direction:<?php echo getTextValue('dir', $lang); ?>;">
        ...
        <!--        <div class="sider">
                    <div class="c-number">
                        ...
                        <label class="counter" ><?php echo $counterNumber ?></label>
                    </div>
                </div>-->
        <!--            <div class="line"></div>-->
        <div class="row bdy">
...
//            var numberOfTickets = 0;
            ...
            lastTransactionsXML.onreadystatechange = function () {
                if (lastTransactionsXML.status == 200 && lastTransactionsXML.readyState == 4)
                {
                    ...
                    {
                        numberOfTickets = retJSON.length - 1;
//                        if (isAudio) {
//                             checkAudios();
//                        }
            ...
            function getLastTransactions(id) {
                lastTransactionsXML.open("GET", "../api/bigdisplay/countercalls.php?id=" + id + "&max=" + maxTransactions, true);
