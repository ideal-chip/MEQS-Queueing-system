<div class="well well-header"><?php echo getTextValue("addEditZone", $lang) ?></div>
...
<form method='POST' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" > 
    ...
    <table class="table">
        <tr>
            <td><?php echo getTextValue("zoneName", $lang) ?></td>
            <td><input type='text' name='name' value='<?php echo $zoneName ?>'></td>
        </tr>
        <tr>
            <td><?php echo getTextValue("zoneDesc", $lang) ?></td>
            <td><input type='text' name='desc' value='<?php echo $zoneDesc ?>'></td>
        </tr>
        <tr>
            <td colspan='2'>
